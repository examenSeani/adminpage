...
import { TerceraServicesService } from '../../services/tercera.service.service';
import { ExporterService } from '../../services/exporter.service';
declare var $:any;

@Component({
  selector: 'app-tercera-etapa',
  templateUrl: './tercera-etapa.component.html',
  styleUrls: ['./tercera-etapa.component.css']
})
export class TerceraEtapaComponent implements OnInit {
  ...
  constructor(  public alumnoService: TerceraServicesService, private auth: AuthService, private router:Router,  private ExporterService: ExporterService) { }
